            ...
            <div className="flex">
                ...
                <div className="basis-1/2 p-10">
                    ...
                    <div className="flex h-8">
                        <input className="w-1/2 p-2 mx-2 border-solid border-2" type="text" placeholder="Your email here"></input>
                        <button className="bg-orange-500 text-white px-2 font-thin w-36 rounded-sm">Subcribe</button>
                    </div>
